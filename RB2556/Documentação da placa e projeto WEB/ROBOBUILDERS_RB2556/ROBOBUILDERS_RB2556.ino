...
// ==========================================
const char* AP_SSID = "ROBOBUILDERS-RB2556";
...
// ==========================================
// MAPEAMENTO DAS GPIOS DA PLACA RB2556 (esp32_relay_30a_x1_v1.1)
// ==========================================
enum PinModeType {
  PIN_MODE_OUTPUT = 0,
  PIN_MODE_INPUT  = 1
...
GPIOPin pins[] = {
  // Pinos Principais Onboard da RB2556
  { 5,  PIN_MODE_OUTPUT, 0, 0 }, // LED Onboard (GPIO 5) - Indicador de Status
  { 16, PIN_MODE_OUTPUT, 0, 0 }, // Relé 30A Principal (GPIO 16) - Saída de Potência
  ...
  { 23, PIN_MODE_OUTPUT, 0, 0 }, // GPIO 23 disponível para expansão
...
void setup() {
  ...
  Serial.println("\n==========================================");
  Serial.println("  ROBOBUILDERS RB2556 - TESTE DE PLACA    ");
  Serial.println("  Modelo: esp32_relay_30a_x1_v1.1        ");
  Serial.println("  LED Onboard: GPIO 5                    ");
  Serial.println("  Rele 30A:    GPIO 16                   ");
