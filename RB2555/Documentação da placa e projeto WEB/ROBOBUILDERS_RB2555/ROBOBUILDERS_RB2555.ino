...
// ==========================================
const char* AP_SSID = "ROBOBUILDERS-RB2555";
...
// ==========================================
// MAPEAMENTO DAS GPIOS DA PLACA RB2555 (ESP-32_RELAY_30A_X2_V1.1)
// ==========================================
enum PinModeType {
  PIN_MODE_OUTPUT = 0,
  PIN_MODE_INPUT  = 1
...
GPIOPin pins[] = {
  // Pinos Principais Onboard da RB2555 (ESP-32 30A X2)
  { 5,  PIN_MODE_OUTPUT, 0, 0 }, // LED Onboard (GPIO 5) - Indicador de Status
  { 13, PIN_MODE_OUTPUT, 0, 0 }, // Relé 1 (30A - K1) (GPIO 13) - Saída de Potência
  { 12, PIN_MODE_OUTPUT, 0, 0 }, // Relé 2 (30A - K2) (GPIO 12) - Saída de Potência
  { 0,  PIN_MODE_INPUT,  1, 0 }, // Botão Boot / IO0 (GPIO 0) - Entrada com Pull-Up

  // Saídas / Entradas Digitais para Teste e Expansão
...
void setup() {
  ...
  Serial.println("\n==========================================");
  Serial.println("  ROBOBUILDERS RB2555 - TESTE DE PLACA    ");
  Serial.println("  Modelo: ESP-32_RELAY_30A_X2_V1.1        ");
  Serial.println("  LED Onboard: GPIO 5                    ");
  Serial.println("  Rele 1 30A:  GPIO 13 (K1)              ");
  Serial.println("  Rele 2 30A:  GPIO 12 (K2)              ");
